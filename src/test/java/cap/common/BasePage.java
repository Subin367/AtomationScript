...
//            act.moveByOffset(X, Y).click().build().perform();
    ...
    public static void main(String args[]){
        ...
        driver.get("sjdjshjhf");

        System.out.println("----> "+driver.findElement(By.xpath("//h5[.='Edit']")).isDisplayed());
        System.out.println("----> "+driver.findElement(By.xpath("//h5[.='Edit']")).getText());
         System.out.println("----> "+driver.findElement(By.xpath("//h5[.='Login']")).isDisplayed());
        System.out.println("----> "+driver.findElement(By.xpath("//h5[.='Login']")).isEnabled());

        driver.findElement(By.xpath("//h5[.='Login']")).click();
        driver.findElement(By.xpath("//h5[.='Login']")).clear();
        driver.switchTo().activeElement().sendKeys("Yasin");
       // driver.findElement(By.xpath("//h5[.='Login']")).sendKeys("Yasin");

        System.out.println(driver.findElement(By.xpath("//h5[.='Login']")).getAttribute("value"));
